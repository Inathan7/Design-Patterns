...
public class TelaCadastroProduto {
	...
	private void instalarButtonSalvar() {
		...
		//		Produto produto = new Produto();  //MUDAR
		//		produto.setNome(nomeProduto);
		//		produto.setPreco(valorProduto);
				

		//		Venda venda = new Venda();        //MUDAR
		//		venda.setData(Calendar.getInstance().getTime());
				
				

		//		ItemVenda itemVenda = new ItemVenda(); //MUDAR
		...
		//		venda.addItemVenda(itemVenda);
				...
				controllerProduto.cadastrarProduto(nomeProduto, valorProduto);
				controllerProduto.cadastrarVenda(Calendar.getInstance().getTime());
				controllerProduto.CadastrarItemVenda(1);
				

				if (controllerProduto.enviarNotaFiscalPorEmail()) {
