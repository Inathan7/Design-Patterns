...
public class Venda {
	 ...
	 * 
	 * INATHAN:
	 * Baixo Acoplamento e Especialista da Informação.
	 */
	
	
//	private float getSubtotal(ItemVenda itemVenda) {
//		return itemVenda.getProduto().getPreco() * itemVenda.getQuantidade();  // Esse código vai para ItemVenda
//	}
	 ...
	 * aqui, nÃ£o incorreremos num inchamento desta classe? Sera que todas as 
